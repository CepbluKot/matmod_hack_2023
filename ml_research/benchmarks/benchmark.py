...
# modls_2 = [LGBMRegressor, Ridge,  BayesianRidge, Lars, LassoLars, Lasso, ElasticNet, TweedieRegressor,  
#           HuberRegressor, TheilSenRegressor,
          
#           AdaBoostRegressor, BaggingRegressor,  ExtraTreesRegressor, RandomForestRegressor]

modls_2 = [LGBMRegressor]
...
benchmark_results.to_csv('benchmark4.csv')
